    ...
    * Training data is comes in the form of cuDF dataframes,
    ...
    def predict(self, X, predict_model="GPU", algo='auto',
        ...
        if predict_model == "CPU":
            ...
            print(" FIL SPARSE FORMAT IN MAIN RFR DASK PREDICT : ", fil_sparse_format)
            preds = \
    ...
    def _predict_using_fil(self, X, predict_model="GPU", algo='auto',
                           convert_dtype=True, fil_sparse_format='auto',
                           delayed=True):
        print(" shape of X in rfr predict gpu : ", X.shape)
        print(" FIL SPARSE FORMAT IN GPU RFR DASK PREDICT : ", fil_sparse_format)
        print(" ALGO IN GPU RFR DASK PREDICT : ", algo)
